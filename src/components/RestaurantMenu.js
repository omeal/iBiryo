					...
					<View style = {styles.mainContent}>
						...
						<ScrollView style = {styles.fullMenu}>
							...
							<View style = {styles.mainMenuContainer}>
								<TouchableOpacity style = {styles.mainMenu} onPress={()=> { Actions.DetailedMenu();}}>
							...
							<View style = {styles.contactContainer}>
								...
								<View style = {styles.contactDetails}>
									<Text style = {styles.contactItem}>Tel: </Text>
									<Text style = {styles.contactItem}>Email: </Text>
									<Text style = {styles.contactItem}>Address: </Text>
									<Text style = {styles.contactItem}>Keywords: </Text>
									<Text style = {styles.contactItem}>Deals: </Text>
								</View>
							</View>
